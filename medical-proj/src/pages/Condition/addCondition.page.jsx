...
import { AddConditionWrapper } from './styled_components/addCondition.style'
...
class AddConditionPage extends React.Component {
    constructor(props) {
        super(props)
        this.state = {
            deviceTypeValue: '',
                                            ...
                                            <Row>
                                                <Col sm={6}>
                                                    ...
                                                    <Form.Group className="manufacturer">
                                                        <Row>
                                                            <Col sm={12}>
                                                                <Form.Label className="col-sm-4">Condition Type</Form.Label>
                                                                <div className="col-sm-8">
                                                ...
                                                <Col sm={6}>
                                                    <Form.Group className="manufacturer">
                                                        <Row>
                                                            <Col sm={12}>
                                                                <Form.Label className="col-sm-4">Condition</Form.Label>
                                                                <div className="col-sm-8">
                                                                    <Field name="manufacturer" type="text">
                                                                        {({ input, meta, type }) => (
                                                                            <>
...
const connectedAddConditionPage = connect(mapStateToProps)(AddConditionPage)
export { connectedAddConditionPage as AddConditionPage }
